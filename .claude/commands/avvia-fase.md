...
**Aspetta il mio ok** prima di iniziare a creare/modificare file. Ricorda: niente push automatici, niente endpoint inventati (se manca informazione metti un `TODO` esplicito e segnalalo), `npm run check` deve passare pulito prima del commit.
